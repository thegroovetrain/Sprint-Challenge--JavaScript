...
const unisWithUni = graduates.filter((graduate) => graduate.university.search("Uni") >= 0);
...
// THIS DOES NOT MAKE SENSE. ForEach does not return anything, why are you implying i should use that here? forEach WOULD NOT BE USED FOR THIS. 
// I could do it in two lines using let (vs const) and push (which is what I am doing), but why? Seriously why? Why start me off with it saying "const?"
// Anyone and their mother would use map for this.
let displayNames = [];
